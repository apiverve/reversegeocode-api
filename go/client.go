...
const (
	baseURL        = "https://api.apiverve.com/v1/reversegeocode"
	defaultTimeout = 30 * time.Second
)

// Client is the Reverse Geocode API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Reverse Geocode API client.
...
// Execute makes a request to the Reverse Geocode API with typed parameters.
//
