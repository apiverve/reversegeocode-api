// Package reversegeocode provides a Go client for the Reverse Geocode API.
//
// For more information, visit: https://apiverve.com/marketplace/reversegeocode?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Reverse Geocode API.
//
// Parameters:
...
// ResponseData contains the data returned by the Reverse Geocode API.
type ResponseData struct {
	...
	LatitudeClosest string `json:"latitudeClosest"`
	LongitudeClosest string `json:"longitudeClosest"`
	CountryCode string `json:"countryCode"`
	LatitudeClosestCity interface{} `json:"latitudeClosestCity"`
	LongitudeClosestCity interface{} `json:"longitudeClosestCity"`
	Latitude float64 `json:"latitude"`
	Longitude float64 `json:"longitude"`
	EstimatedCity bool `json:"estimatedCity"`
	NearestCities []string `json:"nearestCities"`
}
