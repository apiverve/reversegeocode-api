...
```gradle
dependencies {
    implementation 'com.github.apiverve:reversegeocode-api:1.1.13'
}
```
...
```java
import com.apiverve.reversegeocode.ReverseGeocodeAPIClient;
import com.apiverve.reversegeocode.APIResponse;
import com.apiverve.reversegeocode.APIException;

// Initialize the client
ReverseGeocodeAPIClient client = new ReverseGeocodeAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("lat", 40.714224);
    parameters.put("lon", -73.961452);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/reversegeocode](https://docs.apiverve.com/ref/reversegeocode)
...
- **Documentation:** [https://docs.apiverve.com/ref/reversegeocode](https://docs.apiverve.com/ref/reversegeocode)
- **Issues:** [GitHub Issues](https://github.com/apiverve/reversegeocode-api/issues)
