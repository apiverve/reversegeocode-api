/*
 * Reverse Geocode API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Reverse Geocode API.
 * API Documentation: https://docs.apiverve.com/ref/reversegeocode
 */
...
{
    class ReverseGeocodeExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/reversegeocode";

        /// <summary>
        /// Make a GET request to the Reverse Geocode API
        /// </summary>
        static async Task<JsonDocument> CallReverseGeocodeAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;lat&quot;] &#x3D; 40.714224, [&quot;lon&quot;] &#x3D; -73.961452 };
        ...
        {
            Console.WriteLine("📤 Calling Reverse Geocode API...\n");

            var result = await CallReverseGeocodeAPI();
