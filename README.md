...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/reversegeocode](https://docs.apiverve.com/ref/reversegeocode)

---

## Use Cases

Common use cases for the Reverse Geocode API:
